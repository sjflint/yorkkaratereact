  ...
  return (
    <div>
      <Container className="mt-3">
        ...
        <Row>
          <Col md={6}>
            <p>Please complete this form to register for a trial session</p>
            ...
            <Col md={6}>
              ...
              <ListGroup>
                <ListGroup.Item>
                  ...
                  anyone under 9, and Novices are 9 and over. We have classes
                  for intermediate and advanced too, if you are an experienced
                  karateka moving clubs.
                </ListGroup.Item>
                <ListGroup.Item>
                  Our timetable shows when and where the classes are taking
                  place. Please take a look at our{" "}
              ...
              <ListGroup>
                <ListGroup.Item>
                  Just wear any sports type clothing that will be easy to move
                  in. Tracksuit bottoms and a t-shirt would be perfect.
                </ListGroup.Item>
                <ListGroup.Item>
              ...
              >
                <h5 className="text-white">
                  Can I watch my child do the class?
                </h5>
              </div>
              ...
              >
                <h5 className="text-white">
                  I want my child to learn discipline and self-defence, not to
                  be violent.
                </h5>
              </div>
              ...
              <ListGroup>
                <ListGroup.Item>
                  ...
                  control. This is the essence of karate as a martial art, over
                  a 'combat sport'.
                </ListGroup.Item>
                <ListGroup.Item>
                  Karate will teach your child some practical techniques for
                  self defence and give them the confidence to be able to use
                  them.
                </ListGroup.Item>
                <ListGroup.Item>
              ...
              <ListGroup>
                <ListGroup.Item>
                  Yes we do. We have a very active squad that competes around
                  the country and at natioanl and international level.
                </ListGroup.Item>
                <ListGroup.Item>
                  Competitions are great fun and can provide focus and
                  motivation for training, particularly for children.
                </ListGroup.Item>
                <ListGroup.Item>
...
export default TrialRegistrationScreen;
