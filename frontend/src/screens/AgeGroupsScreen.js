    ...
    <Container>
      ...
      <Tabs defaultActiveKey="under9" className="mb-1 justify-content-center">
        <Tab eventKey="under9" title="Under 9 years old" className="mb-3">
          ...
          <p>
            Let your little dragon learn the art of Shotokan Karate through a
            fun, step-by-step training style suited to younger children. It's no
            secret that children learn differently from adults.
          </p>
          <p>
            Here at JKS York Karate Club, we understand that children as young
            as 4 years old can learn karate but that they need to do so in a
            fashion that will engage them and leave them wanting to learn more.
            All instructors have completed child protection courses, are CRB
            checked and emergency first aid trained. This means that you know
            your child is in safe hands! The syllabus includes learning the
            basic punches, kicks and blocks that are essential to karate, but
            also to learn about self-discipline, focus, concentration and
            respect. These skills are at the heart of martial arts training and
            we make sure they are brought to the fore. We will also teach your
            child about balance, speed, teamwork and other life skills that are
        ...
        <Tab eventKey="9-15years" title="9 - 15 year old" className="mb-3">
          <p className="lead border-bottom border-warning pb-2">
            York Karate Club will allow your child to develop through the belt
            system to reach whatever goal they set for themselves.
          </p>
          <p>
            Karate is a great way for children to develop and learn some of the
            most important life principles, such as dedication, hard work and
            discipline. It also allows them to feel confident in themselves and
            trust their own abilities
          </p>
          <p>
            Whether your child is just looking for a hobby, or to be the next
            World Champion, we have plenty to offer. The martial arts are great
            for confidence, for releasing steam and just being able to enjoy
            exercising! Your child can take karate as seriously as they want,
            either as a fun after school activity or with the intention of
            reaching black belt and beyond.
          </p>
