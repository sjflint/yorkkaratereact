...
import jksjapanOgv from "../img/jksjapan.ogv";
    ...
    <>
      <Container>
        ...
        <section className="pb-4 border-bottom border-warning">
          ...
          <Row className="text-center bg-black align-items-center">
            <Col md={6}>
              <ListGroup className="px-3 py-2">
                <h4>The aims of York Karate Dojo are:</h4>
                <ListGroup.Item>
        ...
        <section className="pb-4 border-bottom border-warning">
          ...
          <p>
            ...
            with exceptional technical ability, boasting an unequalled 100% pass
            rate for black belt gradings and training elite level competitors.
            One student from York Karate Dojo, Harry Hardcastle, is a current
            member of the Karate All Styles England Squad, the first from York
            to ever reach such a standard.
          </p>
        </section>
      </Container>
